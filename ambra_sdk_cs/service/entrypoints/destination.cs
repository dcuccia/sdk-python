...
class Destination:
    ...
    def add(
        ...
        :param hl7_address: Address of an attached HL7 destination (optional catch (for VIRTUAL destinations)
        ...
        :param hl7_port: Port of an attached HL7 destination (optional catch (for VIRTUAL destinations)
